r"""
    sphinx.ext.uml
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Defines a docutils directive for automatically generating uml diagrams.

    Derived from Sphinx extension "inheritance_diagram"

    :copyright: Copyright 2019 Daniel Kastinen
